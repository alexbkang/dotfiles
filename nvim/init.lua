...
vim.pack.add({ "https://github.com/nvim-mini/codediff.nvim" }) -- mini plugins & codediff
...
-- treesitter
vim.api.nvim_create_autocmd("PackChanged", { -- automatically run a build after plugin installs or updates
